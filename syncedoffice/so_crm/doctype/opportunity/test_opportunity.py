...
from syncedoffice.so_crm.doctype.lead.lead import make_customer
from syncedoffice.so_crm.doctype.lead.test_lead import make_lead
from syncedoffice.so_crm.doctype.opportunity.opportunity import make_quotation
from syncedoffice.so_crm.utils import get_linked_communication_list
from syncedoffice.tests.utils import SyncedOfficeTestSuite


class TestOpportunity(SyncedOfficeTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
