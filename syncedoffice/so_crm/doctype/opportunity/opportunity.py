...
from syncedoffice.so_crm.utils import (
	CRMNote,
	copy_comments,
	link_communications,
	link_open_events,
...
from syncedoffice.setup.utils import get_exchange_rate
from syncedoffice.utilities.transaction_base import TransactionBase
...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from syncedoffice.so_crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from syncedoffice.so_crm.doctype.crm_note.crm_note import CRMNote
		from syncedoffice.so_crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from syncedoffice.so_crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
...
def make_quotation(source_name, target_doc=None):
	def set_missing_values(source, target):
		from syncedoffice.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(communication, company, ignore_communication_links=False):
	from syncedoffice.so_crm.doctype.lead.lead import make_lead_from_communication
