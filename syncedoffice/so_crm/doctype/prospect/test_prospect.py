...
from syncedoffice.so_crm.doctype.lead.lead import add_lead_to_prospect
...
class TestProspect(IntegrationTestCase):
	...
	def test_make_customer_from_prospect(self):
		from syncedoffice.so_crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
