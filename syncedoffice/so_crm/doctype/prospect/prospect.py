...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from syncedoffice.so_crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from syncedoffice.so_crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
