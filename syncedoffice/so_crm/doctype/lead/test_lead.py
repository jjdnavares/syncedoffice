...
from syncedoffice.so_crm.doctype.lead.lead import make_opportunity
from syncedoffice.so_crm.utils import get_linked_prospect
from syncedoffice.tests.utils import SyncedOfficeTestSuite


class TestLead(SyncedOfficeTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_leads()
