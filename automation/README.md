...
This template should help get you started developing custom workflow UI for Frappe
...
```
cd apps/todo
npx degit netchampfaris/frappe-ui-starter workflow
cd workflow
yarn
yarn dev
```
...
If you notice the browser URL is `/workflow`, this is the base URL where your workflow app will run in production.
